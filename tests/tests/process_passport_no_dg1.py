...
def padd_dg15(dg15_hex, dg_chunk_size):
    dg15_blocks = 1
    if dg15_hex:
        _, _, dg15_blocks = process_and_pad_hex(dg15_hex, dg_chunk_size)
...
def get_shifts(dg15_hex, ec_hex, dg_hash_algo, hash_algo, sa_hex):
    if (dg15_hex == "0"):
        dg15_hex = "01"
    dg1_hash = ""
    dg15_hash = ""
...
def process_passport(file_path):
    ...
    dg_hash_algo, dg_chunk_size = get_dg_chunk_size(ec_hex)
